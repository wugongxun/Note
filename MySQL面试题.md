...
- `MyISAM的索引方式都是非聚簇的，与InnoDB包含1个聚簇索引是不同的。`
  ...
  ![image-20220709183820796](F:\截图\image-20220709183820796.png)
...
![image-20220709071051043](F:\截图\image-20220709071051043.png)
...
![image-20220709071958145](F:\截图\image-20220709071958145.png)



把一些记录放到页里的示意图就是（这里一页就是一个磁盘块，代表一次IO）：

![image-20220709072138395](F:\截图\image-20220709072138395.png)
...
![image-20220709073749310](F:\截图\image-20220709073749310.png)
...
![image-20220709073749310](F:\截图\image-20220709074801215.png)

![img](F:\截图\1557565-20220429110413866-1755798300.png)
...
![image-20220709080648851](F:\截图\image-20220709080648851.png)
...
![image-20220709130937991](F:\截图\image-20220709130937991.png)
...
![image-20220709134109900](F:\截图\image-20220709134109900-16668534893372.png)
...
![image-20220708235509010](F:\截图\image-20220708235509010.png)
...
![image-20220708233351509](F:\截图\image-20220708233351509.png)

为了提高查询效率，就需要 减少磁盘IO数 。`为了减少磁盘IO的次数，就需要尽量降低树的高度` ，需要把原来“瘦高”的树结构变的“矮胖”，树的每层的分叉越多越好。针对同样的数据，如果我们把二叉树改成 三叉树：

![image-20220708235725124](F:\截图\image-20220708235725124.png)
...
![image-20220708231622916](F:\截图\image-20220708231622916.png)
...
![image-20221027154142690](F:\截图\image-20221027154142690.png)

当再次插入7的时候，这棵树就会发生旋转

![image-20221027154120483](F:\截图\image-20221027154120483.png)
...
![image-20220709002223882](F:\截图\image-20220709002223882.png)
...
![image-20220709002554341](F:\截图\image-20220709002554341.png)



**2-3-4树**

![image-20220709004531952](F:\截图\image-20220709004531952.png)
...
![image-20220712002627554](F:\截图\image-20220712002627554.png)
...
![image-20221028155608009](F:\截图\image-20221028155608009.png)

### ![img](F:\截图\29f7e85dea17e100b38b450d9949a330.png)047 Mysql内部支持缓存查询吗？
...
![image-20220627113443003](F:\截图\image-20220627113443003.png)
...
![image-20220702002430362](F:\截图\image-20220702002430362.png)
...
![image-20220627141453944](F:\截图\执行流程.png)
...
![](F:\截图\b44f857a9bdedcd6a2d53a3971fae7db.png)
...
![image-20220703164220030](F:\截图\image-20220703164220030.png)
...
![image-20220703170334348](F:\截图\image-20220703170334348.png)
...
![img](F:\截图\16701032-f8547d110ba34135.png)
...
![在这里插入图片描述](F:\截图\2021110810071449.png)
...
![img](F:\截图\v2-a48d01fd3478ba4d68207fc7ce757658_r.jpg)
...
![image-20220710101402666](F:\截图\image-20220710101402666.png)
...
![image-20220711122444380](F:\截图\image-20220711122444380.png)
...
![image-20220710000757241](F:\截图\image-20220710000757241.png)
...
![image-20220710000950098](F:\截图\image-20220710000950098.png)
...
![image-20220711123408605](F:\截图\image-20220711123408605.png)
...
![image-20220710001512891](F:\截图\image-20220710001512891.png)
...
![image-20220710001930811](F:\截图\image-20220710001930811.png)
...
![image-20220710002145309](F:\截图\image-20220710002145309.png)
...
![image-20220710002444782](F:\截图\image-20220710002444782.png)
...
![image-20220710002604613](F:\截图\image-20220710002604613.png)
...
![image-20220710003049587](F:\截图\image-20220710003049587.png)
...
![image-20220710110732730](F:\截图\image-20220710110732730.png)
...
![image-20220710153504037](F:\截图\image-20220710153504037.png)
...
![image-20220710153921679](F:\截图\image-20220710153921679.png)
...
![image-20220710155650935](F:\截图\image-20220710155650935.png)
...
![image-20220712065946659](F:\截图\image-20220712065946659.png)
...
![image-20220712065815768](F:\截图\image-20220712065815768.png)
...
![image-20220712065922882](F:\截图\image-20220712065922882.png)
...
![image-20220712070042666](F:\截图\image-20220712070042666.png)
...
![image-20220712070727963](F:\截图\image-20220712070727963.png)
...
![image-20220712070851089](F:\截图\image-20220712070851089.png)
...
![image-20220712070944090](F:\截图\image-20220712070944090.png)
...
![image-20220711125730163](F:\截图\image-20220711125730163.png)
...
![image-20220712071057817](F:\截图\image-20220712071057817.png)
...
![image-20220712071138320](F:\截图\image-20220712071138320.png)
...
![image-20220711132125501](F:\截图\image-20220711132125501.png)
...
![image-20220711131831315](F:\截图\image-20220711131831315.png)
...
![image-20220710142152514](F:\截图\image-20220710142152514.png)
...
![image-20220710130548971](F:\截图\image-20220710130548971.png)
...
![image-20220709211819944](F:\截图\image-20220709211819944.png)
...
![image-20220710131916240](F:\截图\image-20220710131916240.png)
...
![image-20220709212722601](F:\截图\image-20220709212722601.png)
...
![image-20220709231638201](F:\截图\image-20220709231638201.png)
...
![image-20220709215122017](F:\截图\image-20220709215122017.png)
...
![image-20220710181100102](F:\截图\image-20220710181100102.png)
...
![image-20220710172607190](F:\截图\image-20220710172607190.png)
...
![image-20220710172926396](F:\截图\image-20220710172926396.png)
...
![image-20220712071716131](F:\截图\image-20220712071716131.png)

```sql
EXPLAIN SELECT id FROM t1;
```

![image-20220712072055566](F:\截图\image-20220712072055566.png)
...
![image-20220710180257692](F:\截图\image-20220710180257692.png)

**注意：**如果这里的查询条件`只有content1 > 'z'`，那么找到满足条件的索引后也会进行一次索引下推的操作，判断content1 > 'z'是否成立（这是源码中为了编程方便做的冗余判断）

![image-20220712012108900](F:\截图\image-20220712012108900.png)
...
![image-20220710182356817](F:\截图\image-20220710182356817.png)
...
![image-20220710182524371](F:\截图\image-20220710182524371.png)
...
![image-20221106160437906](F:\截图\image-20221106160437906.png)
...
![img](F:\截图\25723371_16499183725J8d.png)
...
![image-20221106171251532](F:\截图\image-20221106171251532.png)

![image-20221106171945037](F:\截图\image-20221106171945037.png)
